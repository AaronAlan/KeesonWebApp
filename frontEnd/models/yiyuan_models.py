...
class PatientMH(models.Model):
    bed_number = models.IntegerField(verbose_name='床号')
    subject_id = models.IntegerField(verbose_name='病号')
    inquiry_date = models.DateField(verbose_name='问诊时间(月/日/年)', blank=True, null=True)
...
class PatientTE(models.Model):
    ...
    date = models.DateField(verbose_name='问诊时间(月/日/年)', blank=True, null=True)
...
class PatientPR(models.Model):
    ...
    date = models.DateField(verbose_name='手术时间(月/日/年)', blank=True, null=True)
...
class PatientPE(models.Model):
    ...
    date = models.DateField(verbose_name='体格检查日期(月/日/年)', blank=True, null=True)
