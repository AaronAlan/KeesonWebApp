...
urlpatterns = [
    ...
    path('ronghua_add_drug_history/<int:bed_id>/', ronghua_views.adddrughistory, name='addDrugHistoryRonghua'),
    path('ronghua_add_nursery_history/<int:bed_id>/', ronghua_views.addnurshistory, name='addNurHistoryRonghua'),
    path('ronghua_add_temperature/<int:bed_id>/', ronghua_views.addtemperature, name='addTempRonghua'),
    path('ronghua_add_baby/<int:bed_id>/', ronghua_views.adddbaby, name='addBabyRonghua'),
]
