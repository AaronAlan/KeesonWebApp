...
urlpatterns = [
    ...
    path('bed_add_details/<str:bed_id>/', yiyuan_views.bedadddetails, name='bedAddDetails'),
    path('add_people/<str:bed_id>/', yiyuan_views.addpeople, name='addPerson'),
    path('add_med_history/<str:bed_id>/', yiyuan_views.addmedhistory, name='addMedHis'),
    path('add_day_diag/<str:bed_id>/', yiyuan_views.adddaydiag, name='addDayDiag'),
    path('add_rad_report/<str:bed_id>/', yiyuan_views.addradreport, name='addRadReport'),
    path('add_drug_history/<str:bed_id>/', yiyuan_views.adddrughistory, name='addDrugHistory'),
    path('add_surg_history/<str:bed_id>/', yiyuan_views.addsurghistory, name='addSurgHistory'),
    path('add_body_status/<str:bed_id>/', yiyuan_views.addbodystatus, name='addBodyStatus'),
