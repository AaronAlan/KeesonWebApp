# Generated by Django 2.0.5 on 2018-06-11 03:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, null=True, verbose_name='检验时间(月/日/年)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bed_number', models.CharField(max_length=64, verbose_name='床号')),
                ('subject_id', models.IntegerField(verbose_name='病号')),
                ('gender', models.CharField(blank=True, choices=[('F', '女性'), ('M', '男性')], max_length=64, null=True, verbose_name='性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, null=True, verbose_name='给药日期(月/日/年)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, null=True, verbose_name='护理时间(月/日/年)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_id', models.CharField(blank=True, max_length=64, null=True, verbose_name='设备号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bed_number', models.IntegerField(verbose_name='床号')),
                ('subject_id', models.IntegerField(verbose_name='病号')),
                ('med_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='用药名称')),
                ('dose', models.CharField(blank=True, max_length=64, null=True, verbose_name='每次用药剂量')),
                ('date', models.DateField(blank=True, null=True, verbose_name='给药日期(月/日/年)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bed_number', models.IntegerField(verbose_name='床号')),
                ('subject_id', models.IntegerField(verbose_name='病号')),
                ('inquiry_date', models.DateField(blank=True, null=True, verbose_name='问诊时间(月/日/年)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bed_number', models.IntegerField(verbose_name='床号')),
                ('subject_id', models.IntegerField(verbose_name='病号')),
                ('category', models.CharField(blank=True, max_length=64, null=True, verbose_name='体格检查名称')),
                ('result', models.CharField(blank=True, max_length=255, null=True, verbose_name='体格检查结果')),
                ('date', models.DateField(blank=True, null=True, verbose_name='体格检查日期(月/日/年)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, null=True, verbose_name='手术时间(月/日/年)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, null=True, verbose_name='问诊时间(月/日/年)')),
