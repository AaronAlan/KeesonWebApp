# Generated by Django 2.0.5 on 2018-06-02 01:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_date', models.DateField(blank=True, null=True, verbose_name='入院日期')),
                ('out_date', models.DateField(blank=True, null=True, verbose_name='出院日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, null=True, verbose_name='给药日期')),
                ('bed_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frontEnd.PatientBed', verbose_name='床号')),
            ],
            options={
